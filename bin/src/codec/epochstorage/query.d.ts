...
export declare const QueryGetStakeStorageRequest: {
    ...
    fromPartial<I extends {
        ...
        index?: string | undefined;
    } & { [K in Exclude<keyof I, "index">]: never; }>(object: I): QueryGetStakeStorageRequest;
};
export declare const QueryGetStakeStorageResponse: {
        ...
        stakeStorage?: ({
            ...
            stakeEntries?: ({
                ...
                deadline?: string | number | (Long & {
                    ...
                    toUnsigned: () => Long;
                    xor: (other: string | number | Long) => Long;
                } & { [K_1 in Exclude<keyof I["stakeStorage"]["stakeEntries"][number]["deadline"], keyof Long>]: never; }) | undefined;
                endpoints?: ({
                    iPPORT?: string | undefined;
                    useType?: string | undefined;
                    geolocation?: string | number | Long | undefined;
    ...
    } & { [K_9 in Exclude<keyof I, "stakeStorage">]: never; }>(object: I): QueryGetStakeStorageResponse;
};
export declare const QueryAllStakeStorageRequest: {
    ...
    } & { [K_3 in Exclude<keyof I, "pagination">]: never; }>(object: I): QueryAllStakeStorageRequest;
};
export declare const QueryAllStakeStorageResponse: {
        ...
        stakeStorage?: ({
            ...
            stakeEntries?: ({
                ...
                deadline?: string | number | (Long & {
                    ...
                    toUnsigned: () => Long;
                    xor: (other: string | number | Long) => Long;
                } & { [K_1 in Exclude<keyof I["stakeStorage"][number]["stakeEntries"][number]["deadline"], keyof Long>]: never; }) | undefined;
                endpoints?: ({
                    iPPORT?: string | undefined;
                    useType?: string | undefined;
                    geolocation?: string | number | Long | undefined;
    ...
    } & { [K_12 in Exclude<keyof I, keyof QueryAllStakeStorageResponse>]: never; }>(object: I): QueryAllStakeStorageResponse;
};
export declare const QueryGetEpochDetailsRequest: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): QueryGetEpochDetailsRequest;
};
export declare const QueryGetEpochDetailsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & { [K_2 in Exclude<keyof I["EpochDetails"], keyof EpochDetails>]: never; }) | undefined;
    } & { [K_3 in Exclude<keyof I, "EpochDetails">]: never; }>(object: I): QueryGetEpochDetailsResponse;
};
export declare const QueryGetFixatedParamsRequest: {
    ...
    fromPartial<I extends {
        ...
        index?: string | undefined;
    } & { [K in Exclude<keyof I, "index">]: never; }>(object: I): QueryGetFixatedParamsRequest;
};
export declare const QueryGetFixatedParamsResponse: {
    ...
    } & { [K_2 in Exclude<keyof I, "fixatedParams">]: never; }>(object: I): QueryGetFixatedParamsResponse;
};
export declare const QueryAllFixatedParamsRequest: {
    ...
    } & { [K_3 in Exclude<keyof I, "pagination">]: never; }>(object: I): QueryAllFixatedParamsRequest;
};
export declare const QueryAllFixatedParamsResponse: {
    ...
    } & { [K_5 in Exclude<keyof I, keyof QueryAllFixatedParamsResponse>]: never; }>(object: I): QueryAllFixatedParamsResponse;
};
