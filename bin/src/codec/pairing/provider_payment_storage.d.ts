...
export declare const ProviderPaymentStorage: {
    ...
    fromPartial<I extends {
        ...
        unresponsivenessComplaints?: (string[] & string[] & { [K_5 in Exclude<keyof I["unresponsivenessComplaints"], keyof string[]>]: never; }) | undefined;
    } & { [K_6 in Exclude<keyof I, keyof ProviderPaymentStorage>]: never; }>(object: I): ProviderPaymentStorage;
};
